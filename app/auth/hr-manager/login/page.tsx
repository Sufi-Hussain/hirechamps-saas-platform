...
export default function HRManagerLoginPage() {
  ...
  const [credential, setCredential] = useState('hr@acmecorp.com')
  const [password, setPassword] = useState('HRManager@123')
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8 border-t-4 border-purple-500">
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900">HR Manager</h1>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-xs text-blue-700">Email: hr@acmecorp.com</p>
            <p className="text-xs text-blue-700">Password: HRManager@123</p>
          </div>
        </div>
      </div>
    </div>
