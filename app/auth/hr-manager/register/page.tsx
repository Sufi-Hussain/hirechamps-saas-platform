...
import { Users, ArrowLeft, AlertCircle, CheckCircle, ChevronRight } from 'lucide-react'
...
export default function HRManagerRegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    setLoading(true)
    try {
      const response = await fetch('http://localhost:8000/api/accounts/create-hr-user/', {
        method: 'POST',
      ...
      setSuccess(true)
      setTimeout(() => {
        router.push('/auth/hr-manager/login')
      }, 3000)
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-2xl">
          ...
          <div className="flex justify-between items-center mb-4">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center flex-1">
                ...
                {s < 3 && <div className={`flex-1 h-1 mx-2 ${s < step ? 'bg-purple-600' : 'bg-gray-300'}`}></div>}
              </div>
            ))}
          </div>
        ...
        {/* Form */}
        <div className="bg-white rounded-lg shadow-xl p-8 border-t-4 border-purple-500">
          {success && (
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mt-2">Which company are you joining?</p>
              </div>
                ...
                <div className="space-y-3">
                  {organizations.map((org) => (
                    <label
                      ...
                      style={{
                        borderColor: formData.organization_id === org.id ? '#a855f7' : '#e2e8f0',
                        backgroundColor: formData.organization_id === org.id ? '#faf5ff' : '#ffffff',
                      }}
                    >
                      <input
                        type="radio"
              ...
              <Button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 text-white flex items-center justify-center gap-2 disabled:opacity-50"
              >
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href="/auth/hr-manager/login" className="text-purple-600 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
