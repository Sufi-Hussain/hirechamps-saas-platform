...
export default function EmployeeLoginPage() {
  ...
  const [credential, setCredential] = useState('john.doe@acmecorp.com')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex flex-col items-center justify-center px-4">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border-t-4 border-green-500">
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Personal Dashboard</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="john.doe@acmecorp.com or EMP001"
              />
            </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-xs text-blue-700">Email: john.doe@acmecorp.com</p>
            <p className="text-xs text-blue-700">Password: Employee@123</p>
          </div>
        </div>
      </div>
    </div>
